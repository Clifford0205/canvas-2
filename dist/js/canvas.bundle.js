...
function init() {
  ...
  for (var i = 0; i < 100; i++) {
    var radius = Object(_utils__WEBPACK_IMPORTED_MODULE_0__["randomIntFromRange"])(8, 20); // canvas.height-radius為了不讓球球被銀幕的寬截斷

    var x = Object(_utils__WEBPACK_IMPORTED_MODULE_0__["randomIntFromRange"])(radius, canvas.width - radius); // canvas.height-radius為了不讓球球被銀幕的高截斷
...
/*!*************************!*\
  !*** ./src/js/utils.js ***!
  \*************************/
/*! exports provided: randomIntFromRange, randomColor */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
